...
<div class="container">
	...
	<table class="table table-striped">
		...
		@endphp
			...
			<td><button value="{{$user->id}}"  class="btn btn-outline-primary view">View Details</button></td>
		    </tr>
			@endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" id="approve" class="btn btn-primary approval">Approve</button>
        <button type="button" id="reject" class="btn btn-danger reject">Reject</button>
      </form>
      </div>
    </div>
  </div>
...
<script>
    ...
    headers: {
      ...
      $('.reject').click(function()
      {
         var id=$(this).val();
         console.log(id);
         $.get('/training/medicaldirectory/public/admin/reject/'+id,function()
         {
             $('#reject').show();
             $('#reject').text('Approval Rejected');
         });
         $('#mymodal').modal('toggle');
      });
